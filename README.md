<p align="center">
>project. Pelias is an open-source, open-data geocoder originally sponsored by	>project. Pelias is an open-source, open-data geocoder originally sponsored by	  <img height="100" src="https://raw.githubusercontent.com/pelias/design/master/logo/pelias_github/Github_markdown_hero.png">
>[Mapzen](https://www.mapzen.com/). Our official user documentation is	>[Mapzen](https://www.mapzen.com/). Our official user documentation is	</p>
>[here](https://github.com/pelias/documentation).	>[here](https://github.com/pelias/documentation).	<h3 align="center">A modular, open-source search engine for our world.</h3>
